#!/usr/bin/env python
# Aggregates (sums), windows, or subdivides a grid to another grid
# Grid cells and domain must be aligned and on the same projection
# Example script for fauxioapi
# Command line: regrid.py <infile> <outfile> <grid name>
...
def_griddesc = '../data/griddesc.txt'
